...
train =pd.read_csv('D:/PYTHON/外插3.csv', names=columns)
...
test_yR = train_y[0:313,0:1]
test_yT = train_y[0:313,1:2]
...
test_quantity = quantity[0:313,:]
#print(test_quantity.shape)
# (340,2)

test_one = train_one[0:313]
test_two = train_two[0:313]
test_three = train_three[0:313]
...
my_model2.load_state_dict(torch.load('D:/PYTHON/  std2_NNmodel_rtd.pth'))
loss_func = nn.MSELoss()

writer = SummaryWriter('ex_testing_dataSTD_rtd/NN_result')
