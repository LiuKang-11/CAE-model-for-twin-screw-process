...
n_epochs = 501
writer = SummaryWriter('run3/cnn_result')
...
MSE_loss = []
#embeddingvalue = []
writer = SummaryWriter('run3/NN_result')
...
#         tempeture_loss += loss_func(out[0,1], target[0,1]).item()
        writer.add_scalar('predict RTD(test)', outR, i)
...
print(RTD_loss/len(test_yT))
print(batch_loss/len(test_yT))
#0.8091017723968997
#0.9414812623787893
#0.9414812623787893
